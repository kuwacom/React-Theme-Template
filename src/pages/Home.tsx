    ...
    return(
        <div css={HomeCSS}>
            ...
            <Grid container spacing={2}>
                    ...
                    <Item>
                        ...
                        subheader={<></>}>
                            ...
                            <Box sx={{
                                ...
                                {
                                    wsContext.messageHistory.slice().reverse().map((jsonData, i) => (
                                        <ListItem>
                                            <ListItemText>
                ...
                <Grid item xs={6} md={4}>
                    <p>
                        <TextField error={messageInput == ''}
                        helperText={messageInput == '' ? '入力してください' : ''}
                        id='outlined-basic' label="文字を入力"
                        variant="outlined"
                    ...
                    <p>
                        <Tooltip title="メッセージをサーバーに送信します">
                            <Button variant='contained' color='secondary' disabled={messageInput == ''}
                            onClick={() => {
